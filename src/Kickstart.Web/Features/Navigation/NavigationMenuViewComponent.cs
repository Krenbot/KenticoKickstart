...
public class NavigationMenuViewComponent : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(string navigationMenuCodeName)
    {
        ...
        {
            return View(
                "~/Features/Navigation/NavigationMenuViewComponent.cshtml",
    ...
    private async Task<NavigationMenu> RetrieveMenu(string navigationMenuCodeName)
    {
        var builder = new ContentItemQueryBuilder()
            .ForContentType(
                NavigationMenu.CONTENT_TYPE_NAME,
                config =>
                    config
                        .Where(where =>
                            where.WhereEquals(
                                nameof(NavigationMenu.NavigationMenuCodeName),
        ...
        var items = await contentQueryExecutor.GetMappedResult<NavigationMenu>(
            builder,
